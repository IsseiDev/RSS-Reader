...
/**
 * Class to allow reading of posts offline, and without cache.
 */
public class OfflineActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.scrollview).setVerticalFadingEdgeEnabled(true);
        // Get the feed object
        ...
        // Set the views
        browser.loadDataWithBaseURL("http://www.androidpit.com/feed/main.xml", feed.getItem(position).getDescription(), "text/html", "UTF-8", null);
    }
